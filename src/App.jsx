          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className="flex items-center">
                <div className={`flex items-center space-x-3 px-4 py-3 rounded-full transition-all ${isCompleted ? 'bg-emerald-100 text-emerald-700' :
                  isCurrent ? 'bg-emerald-500 text-white shadow-lg' :
